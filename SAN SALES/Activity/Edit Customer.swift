...
import FSCalendar
import Foundation
class Edit_Customer: IViewController,CustomCheckboxViewDelegate,CustomFieldUploadViewDelegate,CustomSelectionLabelViewDelegate,CustomTextFieldDelegate,UITableViewDelegate, UITableViewDataSource,FSCalendarDelegate,FSCalendarDataSource,CustomRangeFieldViewDelegate,CustomTextNumberFieldDelegate,CustomTextField_Multiple_lineDelegate,CustomRadioButtonViewDelegate,CustomCurrencyTextNumberFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
