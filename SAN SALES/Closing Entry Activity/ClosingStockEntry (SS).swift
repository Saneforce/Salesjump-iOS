//
//  ClosingStockEntry (SS).swift
//  SAN SALES
//
//  Created by Mani V on 07/10/24.
//
...
class ClosingStockEntry__SS_: IViewController, UICollectionViewDelegate, UICollectionViewDataSource, UITableViewDelegate,UITableViewDataSource, UIImagePickerControllerDelegate & UINavigationControllerDelegate{
  ...
  func updateQty(id: String,sUomConv: String,sNetUnt: String,sQty: String,ProdItem:[String: Any],SelMod:String,Text_Data:String,row:Int,section:Int){
      ...
      if(RateItems.count>0){
          Rate = (RateItems[0]["SS_Base_Rate"] as? NSString ?? "0").doubleValue
